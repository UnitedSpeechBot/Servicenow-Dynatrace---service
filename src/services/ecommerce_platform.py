...
class DatabaseAccessLayer:
    ...
    def update_stock(self, product_id: str, quantity_change: int) -> bool:
        ...
        # Fixed: Handle negative stock gracefully
        if new_stock < 0:
...
class PricingEngine:
    ...
    def calculate_final_price(self, base_price: float, quantity: int, state_code: str) -> float:
        ...
        # Fixed: Add type validation/casting for quantity
        try:
        ...
        try:
            for item in items:
                ...
                try:
                    ...
                    logger.warning(f"Invalid quantity value: {qty} for product {pid}. Using default of 1.")
                    qty_int = 1
